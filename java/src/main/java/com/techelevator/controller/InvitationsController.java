...
import java.util.List;
    ...
    public List<Invitations> getByReceiverId(@PathVariable int receiver_id) throws Exception {
        List<Invites> invitations = null;
...
//    @GetMapping(path = "invitee/{receiver_id}")
//    public List<Invitations> getInvitationsByReceiverId(@PathVariable int receiver_id) throws Exception {
